...
4.  **Create the Self-Contained Application Image:**
    ...
    ```bash
    jpackage --type app-image --dest release --input target --name NFmp3Downloader --main-class com.mps.App --main-jar NFmp3Downloader-3.0.0.jar --java-options "-Dfile.encoding=UTF-8" --icon src/main/resources/icon.ico --app-version 3.0.0 --vendor "mps" --copyright "Copyright (c) 2025 mps"
    ```
